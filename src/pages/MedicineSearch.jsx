            ...
            <div className="flex-1">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-14 pr-4 py-4 text-lg font-bold border border-slate-300 rounded-2xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 bg-white/80 backdrop-blur-sm"
                />
              </div>
            </div>
